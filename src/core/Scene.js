...
import {Annotation} from "../tools/annotations/Annotation.js";
import {CameraMode, LengthUnits} from "./defines.js";
import {View} from "./View.js";
import {computeTransformedBoundingBox} from "../utils/geometry.js";
import {createBackgroundTexture} from "../utils/texture.js";
...
export class Scene extends EventDispatcher{
	...
	constructor(){
		...
		this.cameraP = new THREE.PerspectiveCamera(60, 1, 0.1, 1000 * 1000);
	...
	estimateHeightAt(position){
		...
		for(let pointcloud of this.pointclouds){
			...
			while(stack.length > 0){
				...
				let inside = ray.intersectBox(box, new THREE.Vector3());
	...
	initialize(){
		...
		this.cameraScreenSpace.lookAt(new THREE.Vector3(0, 0, 0));
