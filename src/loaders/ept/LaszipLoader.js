...
import {Las, Bounds, Key} from "copc";
import {workerPool} from "../LoaderState.js";

const workerURL = new URL("../../workers/EptLaszipDecoderWorker.js", import.meta.url).href;
...
export class EptLaszipLoader {
	...
	async parse(node, compressed) {
		...
		try {
			const get = async (begin, end) => new Uint8Array(compressed, begin, end - begin);
