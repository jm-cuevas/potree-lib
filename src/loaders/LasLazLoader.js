...
import {LASFile, LASDecoder} from "./las/laslaz.js";
...
const workerURL = new URL("../workers/LASDecoderWorker.js", import.meta.url).href;
...
export class LasLazBatcher{
	...
	push (lasBuffer) {
		const worker = workerPool.getWorker(workerURL);
