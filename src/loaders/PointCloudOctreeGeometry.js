...
export class PointCloudOctreeGeometry {
	...
	constructor() {
		...
		this.loader = null;
		// Populated by POCLoader.load() - declared here so consumers (e.g.
		// BinaryLoader.js, which already reads `pcoGeometry.offset.x/y/z`)
		// typecheck against a complete shape.
...
export class PointCloudOctreeGeometryNode extends PointCloudTreeNode {
	...
	constructor(name, pcoGeometry, boundingBox) {
		...
		// set once loadHierachyThenPoints() decodes the .hrc chunk covering this node
	...
	load() {
		if (this.loading === true || this.loaded === true || loaderState.numNodesLoading >= loaderState.maxNodesLoading) {
			return;
		}
