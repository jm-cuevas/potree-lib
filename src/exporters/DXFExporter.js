 ...
 *
 * Exports {@link Measure} objects to a minimal AutoCAD DXF (R10 / AC1006).
 * A single-point measurement becomes a `CIRCLE`, a multi-point measurement a
 * `POLYLINE` (closed when `measure.closed`). Pure string transform - it reads
 * `measure.points[i].position` (a `THREE.Vector3`) and nothing DOM-side.
 */
