...
/**
 * Orchestrates `Profile` insertion and per-frame marker sizing. Owns a
 * private overlay `THREE.Scene` drawn in the `render.pass.perspective_overlay`
 * pass. Instantiate with `new ProfileTool(viewer)`; `startInsertion()` drags
 * a new profile poly-line onto the point cloud.
 */
