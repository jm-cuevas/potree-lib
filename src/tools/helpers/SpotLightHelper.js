...
/**
 * Visual helper for a `THREE.SpotLight`: a small sphere at the light origin
 * plus a wireframe cone/frustum showing its direction, angle and range.
 * Pure three.js - `update()` re-syncs it to the light's current transform.
 */
