...
/**
 * Renders a point cloud scene from a light's point of view into a depth+color
 * render target, for the EDL renderer's single-shadow-map pass.
 */
export class PointCloudSM {
	...
	constructor(potreeRenderer) {
		...
		this.target.depthTexture = new THREE.DepthTexture(undefined, undefined, THREE.UnsignedIntType);
